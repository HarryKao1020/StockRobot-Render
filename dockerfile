...
# 更新 Ubuntu 軟體源，安裝必要的套件和工具，包括 unzip
RUN apt-get update && apt-get install -y python3.11 python3-pip net-tools htop wget gnupg unzip && \
    apt-get clean && rm -rf /var/lib/apt/lists/*
